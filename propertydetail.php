            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Investment Calculator</h4>
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <button type="submit" value="submit" name="calc" class="btn btn-primary mt-4">Calclute Investment</button>
                        </form>
