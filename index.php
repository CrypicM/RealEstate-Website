...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/5.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Buy and sell properties on our portal.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Rent affordable and quality properties.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>List and manage your properties seemlessly.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-primary flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Calculate Your Investment</a></h5>
                                <p>Find the exact cost of your investment.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">HOUSING SECURITY</h5>
										<p>Explore homes with confidence. Our listings prioritize your safety and peace of mind, adhering to the highest security standards.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">GOOD NEIGHBORHOOD</h5>
										<p>Discover the joy of living in a welcoming community. Our listings feature homes in areas known for friendliness, great schools, and a strong sense of belonging.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">RELIABLE AGENTS</h5>
										<p>Trust our experienced agents to guide you through a seamless real estate journey. We prioritize transparency, communication, and personalized service to make your experience exceptional.</p>
									</div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">The Process</h2>
                        </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Browse and Select property</h5>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Contact Agent</h5>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
